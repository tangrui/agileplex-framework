 ...
 * <ul>
 *   <li>{@link com.agileplex.framework.configuration.impl.DocumentRootImpl#getMixed <em>Mixed</em>}</li>
 *   <li>{@link com.agileplex.framework.configuration.impl.DocumentRootImpl#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 *   <li>{@link com.agileplex.framework.configuration.impl.DocumentRootImpl#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
 *   <li>{@link com.agileplex.framework.configuration.impl.DocumentRootImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DocumentRootImpl extends EObjectImpl implements DocumentRoot {
	...
	public Configuration getConfiguration() {
		return (Configuration)getMixed().get(ConfigurationPackage.Literals.DOCUMENT_ROOT__CONFIGURATION, true);
	}
